                        ...
                        <td class="p-4 py-5">
                            <div class="flex flex-row items-center space-x-2">
                                ...
                                <a href="{{ route('esop.print', ['id' => $esop->id]) }}">
                                    <button
                                        type="button"
                                        class="cursor-pointer rounded-sm bg-green-600 px-2 py-2 text-xs font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline-offset-2 focus-visible:outline-green-700"
                                        title="Cetak SOP"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <td class="p-4 py-5">
                                <div class="flex flex-row items-center space-x-2">
                                    ...
                                    <a href="/esop/print/${esop.id}">
                                        <button type="button" class="cursor-pointer rounded-sm bg-green-600 px-2 py-2 text-xs font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline-offset-2 focus-visible:outline-green-700" title="Cetak SOP">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
