<x-layout>
    ...
    <div class="mt-1 mb-3 flex w-full items-center justify-between pl-3">
        <div>
            @if (Auth::user()->role == 'admin')
                <h3 class="text-lg font-semibold text-slate-800">SOP Disahkan</h3>
                <p class="text-sm text-slate-600">SOP yang sudah disahkan</p>
            @elseif (Auth::user()->role == 'obu')
                <h3 class="text-lg font-semibold text-slate-800">SOP UPBU Disahkan</h3>
                <p class="text-sm text-slate-600">SOP yang sudah disahkan dari Unit Pelaksana Bandar Udara</p>
            @else
                <h3 class="text-lg font-semibold text-slate-800">SOP Disahkan</h3>
                <p class="text-sm text-slate-600">SOP yang sudah disahkan</p>
            @endif
        ...
        <div class="ml-3">
            <div class="relative w-full max-w-sm min-w-[200px]">
                <div class="relative w-80">
                    <input
                        id="searchInputDisahkanEsops"
                        class="ease h-10 w-full rounded border border-slate-200 bg-white py-2 pr-11 pl-3 text-sm text-slate-700 shadow-sm transition duration-200 placeholder:text-slate-400 hover:border-slate-400 focus:border-slate-400 focus:shadow-md focus:outline-none"
                        placeholder="Cari SOP disahkan..."
                        type="text"
                    />
                    <button
                        class="absolute top-1 right-1 my-auto flex h-8 w-8 items-center rounded bg-white px-2"
    ...
    >
        <table class="w-full table-auto text-left">
            ...
            <tbody class="tableBodyDisahkanEsops">
                @foreach ($disahkanEsops as $index => $esop)
                    <tr class="tr_pegawai border-b border-slate-200 hover:bg-slate-50">
                        <td class="p-4 py-5">
                            <p class="block text-sm font-semibold text-slate-800">
                                {{ ($disahkanEsops->currentPage() - 1) * $disahkanEsops->perPage() + $index + 1 }}
                            </p>
                        </td>
                        <td class="p-4 py-5">
                            <p class="text-sm text-slate-600">{{ $esop->user->name ?? '-' }}</p>
        ...
        <div class="items-center justify-between px-4 py-3">
            {{ $disahkanEsops->links('pagination.pagination') }}

            <div class="">
                <a
                    href="{{ route('esop.export.disahkan') }}"
                    class="flex w-fit cursor-pointer items-center justify-center rounded-md bg-green-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-400"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mt-1 mb-3 flex w-full items-center justify-between pl-3">
        <div>
            @if (Auth::user()->role == 'admin')
                <h3 class="text-lg font-semibold text-slate-800">SOP Draft</h3>
                <p class="text-sm text-slate-600">SOP yang masih dalam tahap draft</p>
            @elseif (Auth::user()->role == 'obu')
                <h3 class="text-lg font-semibold text-slate-800">SOP UPBU Draft</h3>
                <p class="text-sm text-slate-600">SOP draft dari Unit Pelaksana Bandar Udara</p>
            @else
                <h3 class="text-lg font-semibold text-slate-800">SOP Draft</h3>
                <p class="text-sm text-slate-600">SOP yang masih dalam tahap draft</p>
            @endif
        ...
        <div class="ml-3">
            <div class="relative w-full max-w-sm min-w-[200px]">
                <div class="relative w-80">
                    <input
                        id="searchInputDraftEsops"
                        class="ease h-10 w-full rounded border border-slate-200 bg-white py-2 pr-11 pl-3 text-sm text-slate-700 shadow-sm transition duration-200 placeholder:text-slate-400 hover:border-slate-400 focus:border-slate-400 focus:shadow-md focus:outline-none"
                        placeholder="Cari SOP draft..."
                        type="text"
                    />
                    <button
                        class="absolute top-1 right-1 my-auto flex h-8 w-8 items-center rounded bg-white px-2"
    ...
    >
        <table class="w-full table-auto text-left">
            ...
            <tbody class="tableBodyDraftEsops">
                @foreach ($draftEsops as $index => $esop)
                    <tr class="tr_pegawai border-b border-slate-200 hover:bg-slate-50">
                        <td class="p-4 py-5">
                            <p class="block text-sm font-semibold text-slate-800">
                                {{ ($draftEsops->currentPage() - 1) * $draftEsops->perPage() + $index + 1 }}
                            </p>
                        </td>
                        <td class="p-4 py-5">
                            <p class="text-sm text-slate-600">{{ $esop->user->name ?? '-' }}</p>
        ...
        <div class="items-center justify-between px-4 py-3">
            {{ $draftEsops->links('pagination.pagination') }}

            <div class="">
                <a
                    href="{{ route('esop.export.draft') }}"
                    class="flex w-fit cursor-pointer items-center justify-center rounded-md bg-green-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-400"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        setupSearch('searchInputDisahkanEsops', '.tableBodyDisahkanEsops');
        setupSearch('searchInputDraftEsops', '.tableBodyDraftEsops');
    });
</script>
